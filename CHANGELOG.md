...
### Added
- North-star re-review loop (WO-033): material change reopens permission against postgres Decision Graph. Fail-closed if store is not postgres. /team remains Coming next / not live. Not paid Team Graph GA.
